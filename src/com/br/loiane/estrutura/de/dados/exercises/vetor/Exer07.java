...
import com.br.loiane.estrutura.de.dados.activities.vetor.Contato;
...
public class Exer07 extends Exer06 {
    public static void main(String[] args) {
        ...
        //criar um menu para o usuario escolher a opção
        int opcao = 1;
        while (opcao != 0) {
    ...
    private static void excluirContato(Scanner scan, ArrayList<Contato> lista) {
        int pos = leInformacaoInt("Entre com a position a ser removida", scan);
        try {
    ...
    private static void pesquisarContatoExiste(Scanner scan, ArrayList<Contato> lista) {
        ...
        try {
            ...
            } else System.out.println("Contato não existe" + pos);
